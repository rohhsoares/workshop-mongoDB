package com.robsoares.workshop.resources;
...
import com.robsoares.workshop.services.UserService;
...
public class UserResource {
	...
	@PostMapping
	public ResponseEntity<Void> fromDTO(@RequestBody UserDTO objDto) {
